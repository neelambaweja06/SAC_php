              ...
              <?php endif; ?>
                    ...
                    <input type="hidden" name="student_code" class="form-control" id="student_code" value="<?= $user['student_code']; ?>" >
                            <div class="form-row">
                                ...
                                <input type="text" name="student_name_first" class="form-control" id="student_name_first"
               value="<?= $user['student_name_first']; ?>" placeholder=""
               <?= !empty($user['student_name_first']) ? 'readonly' : 'required'; ?>>
                                </div>
                                <div class="form-group col-md-4">
                                <label for="student_name" >Student Last Name</label>
                                <input type="text" name="student_name_last" class="form-control" id="student_name_last" value="<?= $user['student_name_last']; ?>" placeholder=""  <?= !empty($user['student_name_last']) ? 'readonly' : 'required'; ?>>
                                </div>
                                <div class="form-group col-md-4">
                                <label for="email" >Student DOB</label>
                            <input type="date" name="student_dob" class="form-control" id="student_dob" value="<?= $user['student_dob']; ?>" placeholder=""  <?= !empty($user['student_dob']) ? 'readonly' : 'required'; ?>>
                                </div>
                            </div>
                            <div class="form-row">
                            ...
                            <select name="student_gender" class="form-control">
                                <?= !empty($user['student_gender']) ? 'disabled' : 'required'; ?>>
               ...
               value="<?= $user['student_father_name']; ?>" placeholder=""
               <?= !empty($user['student_father_name']) ? 'readonly' : 'required'; ?>>
               ...
               value="<?= $user['student_mother_name']; ?>" placeholder=""
               <?= !empty($user['student_mother_name']) ? 'readonly' : 'required'; ?>>
                                </div>
                                <div class="form-group col-md-6">
                     ...
                     <option value="<?php echo $data['id']; ?>"<?php if ($data['id'] === $user['student_class']) echo 'selected="selected"'?>><?php echo $data['class_name']; ?></option>
                      <?php } ?>
                           ...
                           <div class="form-group col-md-6">
                            ...
                            <option value="<?php echo $data['id']; ?>"<?php if ($data['id'] === $user['student_status']) echo 'selected="selected"'?>><?php echo $data['st_name']; ?></option>
                            <?php } ?>
                            </select>
                            </div>
                            </div>
